...
let AppController = class AppController {
    ...
    calculateScoreWithSpares(frames) {
        const score = new bowling_score_1.BowlingScore(frames);
        return score.calculateTotalScoreWithSpare();
    }
    calculateTotalScoreWithStrike(frames) {
        const score = new bowling_score_1.BowlingScore(frames);
        return score.calculateTotalScoreWithStrike();
    }
    calculateTotalScoreWithSpareAndStrike(frames) {
        const score = new bowling_score_1.BowlingScore(frames);
...
__decorate([
    ...
    __metadata("design:paramtypes", [Array]),
    __metadata("design:returntype", Number)
], AppController.prototype, "calculateScoreWithSpares", null);
__decorate([
    (0, common_1.Post)('bowling-score'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Array]),
    __metadata("design:returntype", Number)
], AppController.prototype, "calculateTotalScoreWithStrike", null);
__decorate([
    (0, common_1.Post)('bowling-score'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Array]),
    __metadata("design:returntype", Number)
], AppController.prototype, "calculateTotalScoreWithSpareAndStrike", null);
